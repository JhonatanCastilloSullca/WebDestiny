                    ...
                    <Col md={12} className="about-intro">
                        <Row>
                            ...
                            <Col lg={12} className="pt-4 text-center">
                                <h6 className="section-title text-primary text-uppercase">{t("nosotros.sobre-nosotros")}</h6>
                                <h1 className="mb-4">{t("nosotros.por-que-elegir")} <span className="text-primary text-uppercase">Destiny Travel? </span></h1>
